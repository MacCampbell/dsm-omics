...
```{sh, eval=FALSE}
srun -p med -t 2-12:00:00 --mem=32G --nodes=1 $HOME/angsd/angsd -b bamlists/testHDI.bamlist -anc $HOME/genomes/GCF021917145.1/GCF_021917145.1_fHypTra1_genomic.fna \
