...
`cat ../meta/methyl-list.txt | while read line; do echo "gunzip -c /group/millermrgrp4/maccamp/smelt-bis/$line*.gz > /home/maccamp/Methylation/00-RawData/$line.fastq" > methyl-commands-$line.sh; echo "gunzip -c /group/millermrgrp4/maccamp/smelt-bis-2/$line*.gz >> /home/maccamp/Methylation/00-RawData/$line.fastq" >> methyl-commands-$line.sh;  done;`
