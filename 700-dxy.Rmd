...
```{sh, eval=FALSE}
srun -p bigmemm -t 2-12:00:00 --mail-type=ALL --mem=32G --nodes=1 $HOME/angsd/angsd -nThreads 6 \
  -minMaf 0.05 -minMapQ 20 -minQ 20 -GL 1 -doMajorMinor 1 -doMaf 1 -SNP_pval 1e-6 \
  -doGeno 2 -doPost 1 -postCutoff 0.95 -doPlink 2 -ref $HOME/genomes/GCF021917145.1/GCF_021917145.1_fHypTra1_genomic.fna \
  -bam  bamlists/testHDI.bamlist -minInd 38  -doCounts 1  \
  -out /home/maccamp/extra/genos/all-chroms-HDI > /home/maccamp/extra/genos/testHDI.stdout 2> /home/maccamp/extra/genos/testHDI.stderr &

srun -p bigmemm -t 2-12:00:00 --mail-type=ALL --mem=32G --nodes=1 $HOME/angsd/angsd -nThreads 6 \
  -minMaf 0.05 -minMapQ 20 -minQ 20 -GL 1 -doMajorMinor 1 -doMaf 1 -SNP_pval 1e-6 \
  -doGeno 2 -doPost 1 -postCutoff 0.95 -doPlink 2 -ref $HOME/genomes/GCF021917145.1/GCF_021917145.1_fHypTra1_genomic.fna \
  -bam  bamlists/testLDI.bamlist -minInd 44 -doCounts 1  \
  -out /home/maccamp/extra/genos/all-chroms-testLDI >/home/maccamp/extra/genos/testLDI.stdout 2> /home/maccamp/extra/genos/testLDI.stderr &
```
