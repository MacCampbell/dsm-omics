#!/usr/bin/perl
#  Editing on 07142022 to get two different -minInd flags
#use strict;
use warnings;
use Getopt::Long;
...
#  --minInd         minimum number of individuals required, Population 1
#  --minInd2		minimum number of individuals required, Population 2
#
